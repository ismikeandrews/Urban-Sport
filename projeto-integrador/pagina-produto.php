      ...
      <div class="row">
        <aside class="col-sm-5">
          <article class="gallery-wrap">
            <div class="img-big-wrap">
              <div><a href="#"><img src="imagens/produto1.jpg"></a></div>
            </div>
            <div class="img-small-wrap">
              <div class="item-gallery"> <img src="imagens/produto2.jpg"> </div>
              <div class="item-gallery"> <img src="imagens/produto3.jpg"> </div>
              <div class="item-gallery"> <img src="imagens/produto2.jpg"> </div>
              <div class="item-gallery"> <img src="imagens/produto3.jpg"> </div>
            </div>
          </article>
        ...
        <aside class="col-sm-7">
          <article class="card-body p-5">
            <h3 class="title mb-3">Camisa da Seleção Brasileira</h3>

            <p class="price-detail-wrap">
              <span class="price h3 text-warning">
                <span class="currency">R$</span><span class="num"> 200,00</span>
              </span>
              <span>/per un</span>
            </p>
