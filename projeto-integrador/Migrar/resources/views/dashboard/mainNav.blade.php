<div class="btn-toolbar mb-2 mb-md-0">
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenu2">
      <a class="dropdown-item" href="/admin/produto/orderName">Nome</a>
      <a class="dropdown-item" href="/admin/produto/orderNameDesc">Nome decrescente</a>
      <a class="dropdown-item" href="/admin/produto/orderId">Data de publicação</a>
      <a class="dropdown-item" href="/admin/produto/orderIdDesc">Adicionados recentemente</a>
    </div>
  </div>
</div>
